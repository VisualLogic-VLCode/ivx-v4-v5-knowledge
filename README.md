...
npm run release:prepare -- \
  --version 0.1.4 \
  --previous-manifest ./release-out/knowledge-0.1.3/knowledge-stable.json
npm run release:publish -- \
  --plan ./release-out/knowledge-0.1.4/github-release-plan.json \
